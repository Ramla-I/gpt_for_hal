...
impl Registers {
    ...
    pub fn status_read(&self) -> u32 {
        self.status.read() && 0xC01C01F3 
    }

    pub fn status_write(&mut self, value: u32) {
        self.status.write(value && 0x800001F3) 
    }
    ...
    pub fn rctl_write(&mut self, value: u32) {
        self.rctl.write(value && 0x7E9CC33E) 
    }

    pub fn tctl_read(&self) -> u32 {
        self.tctl.read() && 0x91C0180F 
    }

    pub fn tctl_write(&mut self, value: u32) {
        self.tctl.write(value && 0x140180B) 
    }
    ...
    pub fn rxdctl_write(&mut self, value: u32) {
        self.rxdctl.write(value && 0x3F3F3F) 
    }
    ...
    pub fn crcerrs_write(&mut self, value: u32) {
        self.crcerrs.write(value && 0xFFFFFFFF) 
    }

    pub fn mta[31:0]_read(&self) -> u32 {
        self.mta[31:0].read() && 0xFFFFFFFF 
    }

    pub fn mta[31:0]_write(&mut self, value: u32) {
        self.mta[31:0].write(value && 0xFFFFFFFF) 
    }
...
impl Registers {
    ...
    pub fn status_phytype_write(&mut self, value: StatusPhytype) {
        self.status.write((self.status.read() & !0xC) | ((value as u32) << 2))
    }
